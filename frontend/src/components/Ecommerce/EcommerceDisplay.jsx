...
function EcommerceDisplay() {
  ...
  return (
    <div
      id="shop"
      className="bg-dark flex flex-col items-center gap-6 pb-10 w-full"
    >
      <div className="container mx-auto p-4 text-center">
        <h1 className="mb-3 text-4xl text-primary font-pressStart">
          Dino online shop
        </h1>
        <p className="max-w-2xl text-light mx-auto">
      ...
      <section className="container mx-auto flex flex-col items-center gap-6 rounded-lg p-4">
        {/* search and filters  */}
        <EcommerceSearch
          dinos={dinos}
